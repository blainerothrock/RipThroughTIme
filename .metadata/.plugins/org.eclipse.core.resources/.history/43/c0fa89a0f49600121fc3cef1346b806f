...
//	}
	...
	public void generateBackground() {
		...
		Pixmap groundRock9 = new Pixmap(Gdx.files.internal("level1_2/paint9.png"));
		Pixmap groundRock10 = new Pixmap(Gdx.files.internal("level1_2/paint6.png"));
		Pixmap groundRock11 = new Pixmap(Gdx.files.internal("level1_2/paint1.png"));
		Pixmap groundRock12 = new Pixmap(Gdx.files.internal("level1_2/rock1.png"));
		Pixmap groundRock13 = new Pixmap(Gdx.files.internal("level1_2/rock2.png"));
		Pixmap groundRock14 = new Pixmap(Gdx.files.internal("level1_2/rock4.png"));
		Pixmap groundRock15 = new Pixmap(Gdx.files.internal("level1_2/rock6.png"));
		Pixmap groundRock16 = new Pixmap(Gdx.files.internal("level1_2/paint2.png"));
		Pixmap groundRock17 = new Pixmap(Gdx.files.internal("level1_2/paint5.png"));
		...
		Pixmap rock1 = new Pixmap(Gdx.files.internal("level1_2/paint3.png"));
		Pixmap rock2 = new Pixmap(Gdx.files.internal("level1_2/paint4.png"));
		Pixmap rock3 = new Pixmap(Gdx.files.internal("level1_2/paint7.png"));
		Pixmap rock4 = new Pixmap(Gdx.files.internal("level1_2/paint8.png"));
		Pixmap rock5 = new Pixmap(Gdx.files.internal("level1_2/rock3.png"));
		Pixmap rock6 = new Pixmap(Gdx.files.internal("level1_2/rock5.png"));
		Pixmap rock7 = new Pixmap(Gdx.files.internal("level1_2/rock7.png"));
